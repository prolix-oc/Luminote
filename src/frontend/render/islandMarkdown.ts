/**
 * Ported from Lumiverse `frontend/src/components/chat/htmlIslandMarkdown.ts`.
 * Renders markdown embedded inside HTML islands without crossing raw-text
 * or `<svg>` subtrees. Keep in step with upstream.
 */
